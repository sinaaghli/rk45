...
//
{
  ...
  cout << "\n";
  cout << "FLAG             T          Y         Y'          Y_Exact         "
          "Error\n";
  cout << "\n";

  cout << setw(4) << flag << "  " << setw(12) << t << "  " << setw(12) << y[0]
       << "  " << setw(12) << yp[0] << "  " << setw(12) << r4_y1x(t) << "  "
  ...
  for (i_step = 1; i_step <= n_step; i_step++) {
    ...
    t_out = ((float)(n_step - i_step) * t_start + (float)(i_step)*t_stop) /
            (float)(n_step);
...
#define NEQN 1
  ...
  for (i_step = 1; i_step <= n_step; i_step++) {
    ...
    while (flag < 0) {
      ...
      cout << setw(4) << flag << "  " << setw(12) << t << "  " << setw(12)
           << y[0] << "  " << setw(12) << yp[0] << "  " << setw(12) << r4_y1x(t)
           << "  " << setw(12) << y[0] - r4_y1x(t) << "\n";
    }
    flag = -2;
  }
...
#define NEQN 1
  ...
  for (i_step = 1; i_step <= n_step; i_step++) {
    ...
    t_out = ((double)(n_step - i_step) * t_start + (double)(i_step)*t_stop) /
            (double)(n_step);
...
#define NEQN 1
  ...
  for (i_step = 1; i_step <= n_step; i_step++) {
    ...
    while (flag < 0) {
      ...
      cout << setw(4) << flag << "  " << setw(12) << t << "  " << setw(12)
           << y[0] << "  " << setw(12) << yp[0] << "  " << setw(12) << r8_y1x(t)
           << "  " << setw(12) << y[0] - r8_y1x(t) << "\n";
    }
    flag = -2;
  }
